...
ogp_site_url = "https://canonical-self-hosted-github-runner-docs.readthedocs-hosted.com/"
...
linkcheck_anchors_ignore_for_url = [r"https://github\.com/.*", r"https://library\.canonical\.com/.*"]
